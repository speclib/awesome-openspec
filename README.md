...
- [openspec-tdd](https://github.com/yuritoledo/openspec-tdd) - Claude Code, OpenCode, and Pi plugin adding a TDD gate between `opsx:propose` and `opsx:apply` — generates real failing tests from `specs/**/*.md` before implementation begins.
